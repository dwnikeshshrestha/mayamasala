    ...
    <section id="masalas" className="scroll-mt-20 border-t border-line bg-sand py-24 sm:py-32">
      <Container>
        <Reveal>
          <SectionHead
            eyebrow="The range"
            heading="Six blends. Each one ground on its own."
            lead="No master mix, no shared grinder run. Every blend is roasted and ground separately so one spice never carries the ghost of another."
          />
        </Reveal>
        ...
        <Reveal delay={100}>
          <div className="mt-16 flex flex-col items-start gap-4 border-t border-line-strong/50 pt-10 sm:flex-row sm:items-center sm:justify-between">
            <p className="max-w-md text-[0.9375rem] leading-relaxed text-ink-70">
              Looking for a blend that is not listed, or a bulk order for a restaurant? We grind to
              request.
            </p>
